 ...
 */
public class BFJDPlanAdapter extends BaseRecyclerViewAdapter {
     ...
     */
    public BFJDPlanAdapter(List list) {
        super(list);
    }
    ...
    protected void bindDataToItemView(SparseArrayViewHolder sparseArrayViewHolder, int position) {
        ...
        if (clientInfo != null) {
            ...
            viewHolder.setText(R.id.plan_data, clientInfo.getPlanDate());
            viewHolder.setText(R.id.plan_code, clientInfo.getClientCode());
    ...
    public RecyclerView.ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        viewHolder = new SparseArrayViewHolder(
                inflateItemView(parent, R.layout.item_info_plan));
        return viewHolder;
    }
}
